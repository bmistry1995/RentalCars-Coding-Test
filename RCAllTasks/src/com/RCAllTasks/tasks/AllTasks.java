...
public class AllTasks {
	...
	String jsonAddress = "http://www.rentalcars.com/js/vehicles.json";
	...
	public String getPart1() throws JSONException
	{
		...
		ArrayList<Vehicle> vehicleList = jsonResponse.getVehicleList(jsonAddress);
